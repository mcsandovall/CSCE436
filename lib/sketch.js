...
class Pokemon{
  ...
  render(){
    ...
    if (this.side == 'front'){
      createP(this.name + ": " + this.life).style('font-size', '30px').position(this.x + 400, this.y + 200);
    }else{
      createP(this.name + ": " + this.life).style('font-size', '30px').position(this.x + 1000, this.y + 300);
      createButton(this.moves[1].name).position(this.x + 1000, this.y + 380);
      createButton(this.moves[2].name).position(this.x + 1000, this.y + 420);
      createButton(this.moves[3].name).position(this.x + 1140, this.y + 380);
      createButton(this.moves[4].name).position(this.x + 1140, this.y + 420);
    }
  }
...
function pokemonBattle(pokemonName, pokemonName2){ // 1 trainer 2 wild
  ...
  var pokemon = new Pokemon(pokemonName, 'back');
  var pokemon2 = new Pokemon(pokemonName2, 'front');
