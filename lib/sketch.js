...
class Pokemon{
  ...
  render(){
    ...
    if (this.side == 'front'){
      ...
      createP(this.name).style('font-size', '30px').position(this.x-20, this.y+30);
    }else{
      // createP(this.name + ": " + this.life).style('font-size', '30px').position(this.x + 600, this.y + 170);
      createButton(this.moves[1].name).mousePressed(function() {attack(pokemon1, pokemon2, 1)}).position(this.x + 800, this.y + 250);
      createButton(this.moves[2].name).position(this.x + 800, this.y + 300).mousePressed(function() {attack(pokemon1, pokemon2, 2)});
      createButton(this.moves[3].name).position(this.x + 950, this.y + 250).mousePressed(function() {attack(pokemon1, pokemon2, 3)});
      createButton(this.moves[4].name).position(this.x + 950, this.y + 300).mousePressed(function() {attack(pokemon1, pokemon2, 4)});
    }
  }
